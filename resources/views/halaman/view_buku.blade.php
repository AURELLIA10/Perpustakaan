...
<button id="btnTambahBuku">Tambah Buku</button>
            ...
            @foreach ($buku as $index=>$bk)
                <tr>
                    ...
                    <td align="center">
                        ...
                        <button type="button" id="btnEditBuku" class="btn btn-warning" data-toggle="modal" data-target="#modalBukuEdit{{$bk->id_buku}}"> 
                            Edit
                        </button>
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form name="formbukuedit" id="formbukuedit" action="/buku/edit/{{ $bk->id_buku}} " method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" id="kode_buku" name="kode_buku" placeholder="Masukan Kode Buku" value="{{ $bk->kode_buku}}" />
                                                </div>
                                            </div>
